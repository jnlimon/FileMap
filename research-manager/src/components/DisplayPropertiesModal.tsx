    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md max-h-[80vh] overflow-hidden flex flex-col">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Select Display Properties</h3>
          <button
            onClick={onClose}
        ...
        {/* Apply to all option */}
        <div className="mb-4">
          <label className="flex items-center p-3 border border-blue-200 dark:border-blue-600 rounded-md bg-blue-50 dark:bg-blue-900/20 cursor-pointer">
            <input
              type="checkbox"
              checked={applyToAll}
        ...
        <div className="flex-1 overflow-y-auto mb-4 space-y-2">
          {allProperties.map(propertyName => (
            ...
            >
              ...
              />
              <span className="text-gray-900 dark:text-white">{getPropertyDisplayName(propertyName)}</span>
            </label>
          ))}
        </div>
